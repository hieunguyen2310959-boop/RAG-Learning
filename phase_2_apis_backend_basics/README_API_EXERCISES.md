...
Toàn bộ 5 bài API của **Phase 2 (APIs & Backend Basics)** được đặt trong cùng 1 thư mục:

- `phase_2_apis_backend_basics/exercise_1_basic_requests.py`
- `phase_2_apis_backend_basics/exercise_2_env_and_keys.py`
- `phase_2_apis_backend_basics/exercise_3_async_api.py`
- `phase_2_apis_backend_basics/exercise_4_advanced.py`
- `phase_2_apis_backend_basics/exercise_5_real_world.py`

---

## 🎯 Nội Dung 5 Bài Trong Phase 2

### **Exercise 1: Basic Requests** (`phase_2_apis_backend_basics/exercise_1_basic_requests.py`)
...
### **Exercise 2: Environment & API Keys** (`phase_2_apis_backend_basics/exercise_2_env_and_keys.py`)
...
### **Exercise 3: Async API Calls** (`phase_2_apis_backend_basics/exercise_3_async_api.py`)
Gọi API bất đồng bộ với `httpx` và `aiohttp`
...
### **Exercise 4: Advanced Patterns** (`phase_2_apis_backend_basics/exercise_4_advanced.py`)
...
### **Exercise 5: Real-World Projects** (`phase_2_apis_backend_basics/exercise_5_real_world.py`)
...
```bash
# Chạy exercise 1
python phase_2_apis_backend_basics/exercise_1_basic_requests.py

# Chạy exercise 2
python phase_2_apis_backend_basics/exercise_2_env_and_keys.py

# Chạy exercise 3 (có async)
python phase_2_apis_backend_basics/exercise_3_async_api.py

# Chạy exercise 4
python phase_2_apis_backend_basics/exercise_4_advanced.py

# Chạy exercise 5
python phase_2_apis_backend_basics/exercise_5_real_world.py
```
